...
##
## TODO: 
##  a. Import ICD 10 morbidity list and join with colorectal df
###################################################################################
...
# Obtain description of ICD 10 codes


# 2.2 Transform --------------------------------------------------------------------
colnames(df_colorectal) <- c("admission_date", "discharge_date", "surg_code", "surg_name", "los",
