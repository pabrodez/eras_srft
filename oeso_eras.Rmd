...
## Plot
### Rate of PPCs by month
Here, confirmed pneumonias and/or ventilation and/or oxygen are considered PPCs. 
...
oeso_merged %>% 
  ...
  {
  ggplot(.) +
  geom_line(aes(x = year_month, y = ppc_rate, group = 1, colour = baseline)) +
  scale_x_discrete(labels = seq_months, breaks = seq_months) +
